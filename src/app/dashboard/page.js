...
const Dashboard = () => {
  ...
  return (
    <div className="dark:bg-gray-800 dark:text-white">
      <Navbar />
      <div className="p-6">
        <h1 className="text-2xl font-bold mb-4 text-center sm:text-left">Transactions Overview</h1>
        
        {/* Filters */}
        <div className="p-6">
          <div className="mb-4 flex gap-4 flex-wrap">
            <select
              className="border p-2 rounded bg-purple-500 text-white w-full sm:w-auto"
              value={statusFilter}
